 ...
 kubectl delete deployment -A --field-selector metadata.name=windup-operator.0.0.10
 kubectl delete csv -A --field-selector metadata.name=windup-operator.0.0.10
