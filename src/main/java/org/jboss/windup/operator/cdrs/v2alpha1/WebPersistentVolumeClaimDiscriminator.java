...
public class WebPersistentVolumeClaimDiscriminator implements ResourceDiscriminator<PersistentVolumeClaim, Windup> {
    @Override
    public Optional<PersistentVolumeClaim> distinguish(Class<PersistentVolumeClaim> resource, Windup windup, Context<Windup> context) {
        String persistentVolumeClaimName = WebConsolePersistentVolumeClaim.getPersistentVolumeClaimName(windup);
